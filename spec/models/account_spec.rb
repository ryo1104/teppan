...
RSpec.describe Account, type: :model do
  ...
  describe 'method::create_stripe_account' do
    ...
    context 'successfully' do
      ...
      after do
        JSON.parse(Stripe::Account.delete(@result[1]['id']).to_s) if @result[0]
      end
    end
  end
  ...
  describe 'method::delete_stripe_account' do
    ...
    context 'successfully' do
      ...
      after do
        JSON.parse(Stripe::Account.delete(@account.stripe_acct_id).to_s) if @result[0] == false
      end
    end
  end

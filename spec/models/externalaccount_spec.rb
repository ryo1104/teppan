...
RSpec.describe Externalaccount, type: :model do
  ...
  let(:valid_stripe_acct_obj) { 
                                {
                                  ...
                                  "settings"=>{
                                    ...
                                    "tos_acceptance"=>{"date"=>1556468406, "ip"=>"202.32.34.208", "user_agent"=>nil}, "type"=>"custom"} 
                                  }
  ...
  let(:stripe_bank_acct_post_inputs)    { 
                                {
                                  external_account:
                                  {
                                    object:               'bank_account',
